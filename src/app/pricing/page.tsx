...
export default function PricingPage() {
  ...
  /* ═══════════════════════════════════════════════════════
     STEP 0: Price Guess (08_price_guess.html)
     ═══════════════════════════════════════════════════════ */
  if (step === 0) {
    return (
      <div className="font-body selection:bg-primary/30 flex flex-col items-center" style={{ backgroundColor: "#08080C", color: "white", overflow: "hidden", height: "100dvh", maxHeight: "844px" }}>
        {/* Top Navigation Bar */}
        ...
        <main className="w-full max-w-[400px] flex-1 flex flex-col px-[24px] overflow-hidden">
          ...
          {/* Reference Cards - Compacted for single screen fit */}
        ...
        {/* Bottom Navigation Hidden (Task-Focused Journey) */}
      </div>
    );
  }

  /* ═══════════════════════════════════════════════════════
     STEP 1: Free Reveal (09_free_reveal.html)
     ═══════════════════════════════════════════════════════ */
  return (
    <div className="font-body selection:bg-primary/30">
        ...
        <div className="relative z-10 w-full space-y-[80px]">
          ...
          <div className="w-full space-y-[16px] pt-[32px]">
            <button
              ...
              className="w-full h-[56px] gradient-bg text-white font-semibold text-[16px] rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-opacity active:scale-[0.98]"
            >
      ...
      <footer className="w-full max-w-[400px] mx-auto px-7 pb-12 flex flex-col items-center gap-4 bg-transparent">
        ...
        <p className="font-['Sora'] text-[13px] text-white/25">© 2024 FACERANK AI</p>
      </footer>

      {/* Aesthetic Decorative Image (Soft Abstract) */}
      <div className="fixed bottom-0 left-0 w-full h-1/3 pointer-events-none opacity-20 overflow-hidden">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img className="w-full h-full object-cover" alt="abstract flowing liquid shapes in deep purple and indigo with soft studio lighting and grainy texture" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAil74rquhyBCDU0wDwz5gCFEjVJA8L2hK4fon4XK3pT9Oho7ofBPUzRAoUKvgrOXD1SimEj_NtXRWNHb0R0XQ-YKvhRzZ9x8UXJak0CiABpSF7GcIvGFj1u-d0AGJtZH_C5XIUCuy8n1mCKJ-LNPMrvlLS-yM8X_AY_CLvL0zWBDkk8N9U1qDQicX7v7prBteWWU8D2dZwN1iWseyo_j4gK3KnxAGHsJmx0njfP73eo9RzUhg5l8xFLpp4EUU6SuyFlTrhWhg-7Tz0" />
      </div>
    </div>
  );
}
