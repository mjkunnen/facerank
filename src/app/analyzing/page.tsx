...
export default function AnalyzingPage() {
  ...
  return (
    <main className="bg-[#08080C] text-white font-body antialiased min-h-screen overflow-hidden">
      {/* TopAppBar */}
      <header className="fixed top-0 left-0 w-full z-50 px-7 pt-12 flex justify-between items-center max-w-[400px] mx-auto right-0">
        <button className="text-[#7C4DFF] hover:opacity-100 transition-opacity active:scale-95 duration-200">
          <span className="material-symbols-outlined">close</span>
        </button>
        <h1 className="font-headline font-semibold tracking-[-0.035em] uppercase text-[13px] opacity-25 text-white">ANALYZING</h1>
